...
class Wav2Vec2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        dim_inputSpat = 128,
        conv_dim=(64,64,64,128,256,512), #(512, 512, 512, 512, 512, 512, 512),
        conv_stride=(1,1,1,1,1,1),#(5, 2, 2, 2, 2, 2, 2),
        conv_kernel=(10,1,1,1,1,1), #(10, 3, 3, 3, 3, 2, 2),
        conv_kernel_spatial = [5,3,3,3,3,2],
        conv_stride_spatial = [2,1,1,1,1,1],
        maxpool_kernel_spatial = [2,2,2,1,1,1],
        maxpool_stride_spatial = [2,2,2,1,1,1],
