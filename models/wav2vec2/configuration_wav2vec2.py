...
class Wav2Vec2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        activation_dropout=0.3, #0.1,
        attention_dropout=0.3, #0.1,
        feat_proj_dropout=0.3, #0
        feat_quantizer_dropout=0.3, #0
        final_dropout=0.3, #0.1,
        layerdrop=0.3, #0.1,
        ...
        conv_kernel=(1,1,1,1), #(5,5,1,1) #(10, 3, 3, 3, 3, 2, 2),
        conv_kernel_spatial = [3,3,3,2],
        conv_stride_spatial = [2,2,2,1], #3
        maxpool_kernel_spatial = [3,2,1,1],
        maxpool_stride_spatial = [3,2,1,1],
        conv_bias=True,#True, #False,
        num_conv_pos_embeddings=128,
        num_conv_pos_embedding_groups=16,
        do_stable_layer_norm=True, #False,
        apply_spec_augment=True,
        mask_time_prob=0.65, #0.05,
        mask_time_length=3,
        mask_time_min_masks=2,
        mask_feature_prob=0.0,
        mask_feature_length=3,
        mask_feature_min_masks=0,
        num_codevectors_per_group=320,#320,
        num_codevector_groups=2,
        contrastive_logits_temperature=0.1,
        num_negatives=50, #100,
        codevector_dim=256, #256,
        proj_codevector_dim=256,# 256,
        diversity_loss_weight=0.1,
        ctc_loss_reduction="sum",
        ctc_zero_infinity=False,
        use_weighted_layer_sum=False,
        classifier_proj_size=256,#256,
        ...
        output_hidden_size=480, #768 #None,
        ...
        **kwargs,
        ...
        self.conv_kernel_spatial = conv_kernel_spatial
        self.conv_stride_spatial = conv_stride_spatial
        self.maxpool_kernel_spatial = maxpool_kernel_spatial
        self.maxpool_stride_spatial = maxpool_stride_spatial
        ...
        self.output_attentions=output_hidden_states
